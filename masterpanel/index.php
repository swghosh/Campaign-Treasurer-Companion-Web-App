...
?>
        <table class="view">
            ...
            <tr class="news" id="addnews"><td class="time"></td><td class="news"><form>This place will be replaced with a form.</form><br><br></td></tr>
            <tr class="stock"><td class="name">Rollback News Item  <span class="arrow ext">⎋</span></td></tr>
            ...
            <tr class="news" id="addstock"><td class="time"></td><td class="news"><form>This place will be replaced with a form.</form><br><br></td></tr>
            ...
            <tr class="news" id="removestock"><td class="time"></td><td class="news"><form>This place will be replaced with a form.</form><br><br></td></tr>
            ...
            <tr class="news" id="updateprice"><td class="time"></td><td class="news"><form>This place will be replaced with a form.</form><br><br></td></tr>
            <tr class="stock"><td class="name">Rollback Price Update for Cryptocurrency / Commodity / Security  <span class="arrow ext">⎋</span></td></tr>

            <tr class="sector"><td colspan="4" class="sector">Larger Display</td></tr>
            <tr class="stock"><td class="name">Show Market Overview  <span class="arrow ext">⎋</span></td></tr>
            ...
            <tr class="news" id="reversetransaction"><td class="time"></td><td class="news"><form>This place will be replaced with a form.</form><br><br></td></tr>
            <tr class="stock"><td class="name">Show Active Buyers  <span class="arrow ext">⎋</span></td></tr>
            <tr class="stock" id="grantfunds"><td class="name">Grant Funds <span id="grantfunds" class="arrow">⌵</span></td></tr>
            <tr class="news" id="grantfunds"><td class="time"></td><td class="news"><form>This place will be replaced with a form.</form><br><br></td></tr>
            <tr class="stock" id="deductfunds"><td class="name">Deduct Funds <span id="deductfunds" class="arrow">⌵</span></td></tr>
            <tr class="news" id="deductfunds"><td class="time"></td><td class="news"><form>This place will be replaced with a form.</form><br><br></td></tr>
