...
?>
        <table class="view" id="panel">
            ...
            <tr class="sector"><td colspan="4" class="sector copyright"><b>Please do not use this panel without the authorisation/permission of the market administrator/stock exchange board.</b><br><br>© Campaign Treasurer.<br>Designed and Developed by <a href="https://github.com/swghosh" class="author">Swarup Ghosh</a>.</td></tr>
        </table>    
<?php
